...
const MarcasCarousel = () => {
  ...
  const handleImageError = (e) => {
    e.target.style.display = 'none';
    const fallback = e.target.closest('.marca-card').querySelector('.marca-logo-fallback');
    if (fallback) {
    ...
    <section className="marcas-carousel-section">
      ...
      <style jsx>{`
                .marcas-carousel-section {
                    ...
                    background: linear-gradient(to bottom, #101015, #1d1d25);
                    color: #e0e0e0;
                ...
                .marca-logo {
                    ...
                    filter: grayscale(100%) brightness(200%); /* Efecto futurista */
                }
                
                .marca-card:hover .marca-logo {
                    transform: scale(1.1);
                    filter: grayscale(0%) brightness(100%); /* Recupera el color en hover */
                }
                ...
                /* Estilos globales para el carrusel de react-multi-carousel */
                :global(.carousel-container) {
                    padding: 1rem 0;
                }
                ...
                /* Media queries para asegurar el responsive */
                @media (max-width: 768px) {
                    .marca-card {
                        height: 170px;
                    }
